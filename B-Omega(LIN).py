...
xa, ya = np.loadtxt('C:/Users/ADMIN/Desktop/natural/natural-final codes-new reh/new GWs/PkB.dat').T
...
for i in range(31,140):
    a1,e1=integrate.nquad(omega_A,[bound_u,[kmin/xa[i],xa[116]/xa[i]]])
    #a1,e1=integrate.nquad(omega_A,[bound_u,bound_v])
    b1.append(a1)
    s1=beta*xa[i]
    c1.append(s1)
