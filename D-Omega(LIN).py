...
xa, ya = np.loadtxt('C:/Users/ADMIN/Desktop/natural/natural-final codes-new reh/new GWs/PkD.dat').T
...
print("*************set A**********")
for i in range(20,115):
    a1,e1=integrate.nquad(omega_A,[bound_u,[kmin/xa[i],xa[100]/xa[i]]])
   # a1,e1=integrate.nquad(omega_A,[bound_u,bound_v])
    b1.append(a1)
    s1=beta*xa[i]
    c1.append(s1)
